...
class CredentialsControllerTest < ActionController::TestCase
  ...
  test "should create credential" do
    assert_difference('Credential.count') do
      post :create, credential: { count: @credential.count, password: @credential.password, username: @credential.username }
    end
  ...
  test "should update credential" do
    put :update, id: @credential, credential: { count: @credential.count, password: @credential.password, username: @credential.username }
    assert_redirected_to credential_path(assigns(:credential))
  end
